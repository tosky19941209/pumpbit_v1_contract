...
export interface RewardCollectorV3Interface extends utils.Interface {
  functions: {
    ...
    "collectFarmRewardBatch(uint256,uint256[],bytes,address)": FunctionFragment;
...
export interface RewardCollectorV3 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RewardCollectorV3Interface;
