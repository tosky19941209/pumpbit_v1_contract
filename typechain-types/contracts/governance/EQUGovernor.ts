...
export interface EQUGovernorInterface extends utils.Interface {
  functions: {
    "BALLOT_TYPEHASH()": FunctionFragment;
    "CLOCK_MODE()": FunctionFragment;
    "COUNTING_MODE()": FunctionFragment;
    "EFCGovernor()": FunctionFragment;
    "EXTENDED_BALLOT_TYPEHASH()": FunctionFragment;
    "afterExecute(uint256,address[],uint256[],bytes[],bytes32)": FunctionFragment;
    "beforeExecute(uint256,address[],uint256[],bytes[],bytes32)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "beforeExecute",
    values: [
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<string>[],
      PromiseOrValue<BigNumberish>[],
...
export interface EQUGovernor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EQUGovernorInterface;
  ...
  functions: {
    ...
    EFCGovernor(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    EFCGovernor(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    EFCGovernor(overrides?: CallOverrides): Promise<PopulatedTransaction>;
