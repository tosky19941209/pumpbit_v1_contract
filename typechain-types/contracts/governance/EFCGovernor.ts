...
export interface EFCGovernorInterface extends utils.Interface {
  functions: {
    "BALLOT_TYPEHASH()": FunctionFragment;
    "CLOCK_MODE()": FunctionFragment;
    "COUNTING_MODE()": FunctionFragment;
    "EQUGovernor()": FunctionFragment;
    ...
    "routinePropose(address[],uint256[],bytes[],string)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "routinePropose",
    values: [
      PromiseOrValue<string>[],
      PromiseOrValue<BigNumberish>[],
      PromiseOrValue<BytesLike>[],
...
export interface EFCGovernor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EFCGovernorInterface;
  ...
  functions: {
    ...
    EQUGovernor(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    EQUGovernor(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    EQUGovernor(overrides?: CallOverrides): Promise<PopulatedTransaction>;
