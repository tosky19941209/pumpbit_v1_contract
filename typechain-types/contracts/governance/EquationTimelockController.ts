...
export interface EquationTimelockControllerInterface extends utils.Interface {
  functions: {
...
export interface EquationTimelockController extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EquationTimelockControllerInterface;
