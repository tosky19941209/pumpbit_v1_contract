...
export interface GovernableTest extends BaseContract {
  ...
  functions: {
    ...
    onlyGovTest(overrides?: CallOverrides): Promise<[void]>;
  ...
  estimateGas: {
    ...
    onlyGovTest(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    onlyGovTest(overrides?: CallOverrides): Promise<PopulatedTransaction>;
