...
export interface ERC721WeightedVotesInterface extends utils.Interface {
  functions: {
...
export interface ERC721WeightedVotes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721WeightedVotesInterface;
